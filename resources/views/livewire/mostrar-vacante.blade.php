<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-4 my-10">
            ...
            <p class="font-bold text-sm uppercase text-gray-800 my-3">Ultimo día p/ postularse:
                <span class="font-normal normal-case">
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                ...
                <a class="font-bold text-indigo-600" href="{{route('register')}}">Obten una cuenta y aplica a ésta y otras vacantes</a>
            </p>
        </div>
    @endguest
